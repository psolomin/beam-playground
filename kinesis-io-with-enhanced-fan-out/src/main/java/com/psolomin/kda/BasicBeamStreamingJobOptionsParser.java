...
public class BasicBeamStreamingJobOptionsParser {
    private static Logger LOG = LoggerFactory.getLogger(BasicBeamStreamingJobOptionsParser.class);
    ...
    static String[] argsFromKinesisApplicationProperties(String[] args, String applicationPropertiesName) {
        ...
        try {
            ...
            if (applicationProperties == null) {
                throw new IllegalStateException(
                        "Unable to load application properties from the Kinesis Analytics Runtime");
            }
            ...
            if (beamProperties == null) {
                throw new IllegalStateException(String.format(
                        "Unable to load %s properties from the Kinesis Analytics Runtime", applicationPropertiesName));
            }
        ...
        String[] kinesisOptions = beamProperties.entrySet().stream()
